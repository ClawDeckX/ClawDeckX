  ...
  return (
    <div className="space-y-4">
      ...
      <ConfigSection title={es.webSearch} icon="search" iconColor="text-blue-500" defaultOpen={false}>
        ...
        <TextField label={es.provider} tooltip={tip('tools.web.search.provider')} value={g(['web', 'search', 'provider']) || ''} onChange={v => s(['web', 'search', 'provider'], v)} placeholder={es.phWebSearchProvider} />
        <TextField label={es.apiKey} value={g(['web', 'search', 'apiKey']) || ''} onChange={v => s(['web', 'search', 'apiKey'], v)} placeholder={es.phApiKeyMask} />
      </ConfigSection>
      ...
      <ConfigSection title={es.webFetch} icon="language" iconColor="text-green-500" defaultOpen={false}>
        ...
        <TextField label={es.method} tooltip={tip('tools.web.fetch.method')} value={g(['web', 'fetch', 'method']) || ''} onChange={v => s(['web', 'fetch', 'method'], v)} placeholder={es.phWebFetchMethod} />
      </ConfigSection>
