...
const PLUGIN_CATALOG: CatalogEntry[] = [
  ...
  { id: 'openclaw-lark', spec: '@larksuite/openclaw-lark', name: 'Lark / Feishu (Official)', nameZh: '飞书 / Lark（官方）', description: 'Official Lark/Feishu plugin by the Lark team — messenger, docs, base, sheets, calendar, tasks, cards, streaming', descriptionZh: '飞书官方团队插件 — 消息/文档/多维表格/电子表格/日历/任务/交互卡片/流式', icon: '🐦', category: 'channel', relatedChannels: ['openclaw-lark'] },
